...
type SchemaRequirement = {
  _required?: boolean;
  _type?: string;
  _keys?: Record<string, SchemaRequirement>;
  _validate?: (data: any) => boolean;
  _strictMatch?: boolean;
};

function checkObjectAgainstSchema(
...
function checkArrayAgainstSchema(
  objArr: Array<Record<string, any>>,
  schema: Record<string, SchemaRequirement>,
  fullKey: string
): boolean[] {
