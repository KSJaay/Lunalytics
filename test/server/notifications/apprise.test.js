...
describe('Apprise Notifications', () => {
  ...
  it('should send notification successfully', async () => {
    ...
    const result = await apprise.send(
      mockNotification,
      mockMonitor,
      mockHeartbeat
    );
    ...
    expect(NotificationReplacers).toHaveBeenCalledWith(
      AppriseTemplateMessages[mockNotification.messageType] ||
  ...
  it('should handle errors in send', async () => {
    const handleErrorSpy = vi.spyOn(apprise, 'handleError');
  ...
  it('should send recovery notification successfully', async () => {
    ...
    const result = await apprise.sendRecovery(
      mockNotification,
      mockMonitor,
      mockHeartbeat
    );
